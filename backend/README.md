...
## Project Structure
    ...
    ├── supermarioytg_app_30680  # Django project configurations
...
1. Clone this repo and `cd supermarioytg_app_30680`
...
2. Clone this repo and `cd supermarioytg_app_30680`
